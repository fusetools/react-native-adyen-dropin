...
exports.default = exports.RESULT_CODE = exports.AdyenDropInModule = void 0;
...
})(RESULT_CODE || (exports.RESULT_CODE = RESULT_CODE = {}));

const AdyenDropInModule = _reactNative.NativeModules.AdyenDropInModule;
exports.AdyenDropInModule = AdyenDropInModule;
...
const AdyenDropIn = {
  ...
  setModuleConfig(moduleConfig) {
    ...
    if (moduleConfig.callbacks) {
      ...
      AdyenDropInModule.setAdditionalDetailsCallback(moduleConfig.callbacks.onAdditionalDetails);
    }
